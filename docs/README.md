...
| Option            | Requirement | DataType    | Description                              |
| ----------------- | ----------- | ----------- | ---------------------------------------- |
| `subscription_id` | Optional    | String      | License number                           |
...
- A `subscription_id` will be provided through email when you subscribe to a [Pro or Business Subscription Plan](../README.md#subscription-plans).
- An active subscription is required to use the proxy settings.
